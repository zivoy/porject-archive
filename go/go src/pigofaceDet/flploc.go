...
func clusterDetection(pixels []uint8, rows, cols int) []pigo.Detection {
	...
	if len(cascade) == 0 {
		cascade, err = ioutil.ReadFile("../../pkg/mod/github.com/esimov/pigo@v1.4.5/cascade/facefinder")
		if err != nil {
	...
	if len(puplocCascade) == 0 {
		puplocCascade, err := ioutil.ReadFile("../../pkg/mod/github.com/esimov/pigo@v1.4.5/cascade/puploc")
		if err != nil {
		...
		flpcs, err = puplocClassifier.ReadCascadeDir("../../pkg/mod/github.com/esimov/pigo@v1.4.5/cascade/lps")
		if err != nil {

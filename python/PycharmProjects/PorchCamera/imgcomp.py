...
class BWImageCompare(object):
    ...
    def __init__(self, imga: Image.Image, imgb:Image.Image, maxsize=64):
...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 3:
        print(f'usage: {sys.argv[0]} image-file-1.jpg image-file-2.jpg ...')
        sys.exit()
    ...
    print(f'Most different images:\t{imgs[0]} {imgs[1]} ({res:.2f} %)')
